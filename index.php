	...
	<body translate="no">
			...
			<section id="social">
		  	...
		  	<section id="contact">
			  	<p class="contact" style="text-align: justify; padding-left: 20px; padding-right: 20px;">
					<a href="redaction/redaction.html"><span class="majuscule">P</span>age suivante</a>
				</p>
			</section>
		</main>
		<!-- FIN CONTENU -->
		...
		<nav>
		  	<ul>
		    	...
		    	<li class="link"><a href="index.php"><span style="text-decoration:underline;">ACCUEIL</span></a> </li>
