                    ...
                    <?php
                        ...
                        if($list = Demande::getAll()) {
                            foreach ($list as $value) {
                                ...
                                $aff .= "   </td>";
                                $aff .= "   <td>";
                                $aff .= "       <button data-id='".$Demande->getId()."' class='btn btn-success treatment-btn'>Traiter</button>";
                                $aff .= "       <button data-id='".$Demande->getId()."' class='btn btn-danger del-btn'>Supprimer</button>";
                                $aff .= "   </td>";
                                $aff .= "</tr>";
                            }
